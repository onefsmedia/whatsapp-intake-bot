"""
Django settings for WhatsApp Bot project.
"""
...
WHATSAPP_CONFIG = {
    ...
    'VERIFY_TOKEN': config('WHATSAPP_VERIFY_TOKEN', default='ws4ed_whatsapp_verify_token_2025'),
    'API_VERSION': config('WHATSAPP_API_VERSION', default='v18.0'),
}
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'whatsapp_bot.log',
            'formatter': 'verbose',
        },
        'console': {
